...
} *Start=NULL, *End=NULL, *Temp=NULL, *Temp1=NULL;
...
void Create()
{
 ...
 clrscr();
   ...
   printf("\n");
	for(i=0; i<Record; i++)
   	{
       	Temp=(struct Link_List_Next*)malloc(sizeof(struct Link_List_Next));
...
void Insert_First()
{
 clrscr();
   ...
   gotoxy(24,10); cprintf("%d Is Inserted At First Position",Temp->Data);
...
void Insert_Last()
{
 clrscr();
   ...
   textcolor(YELLOW+BLINK);
   gotoxy(24,10); cprintf("%d Is Inserted At Last Position",Temp->Data);
...
void Search()
{
 clrscr();
   ...
   textcolor(RED);
 	gotoxy(5,3); cprintf("Which Data Do You Want Search:- ");
   scanf("%d",&Search_Now);
	...
	if(Temp->Data==Search_Now)
   	{
         ...
         Temp1=(struct Link_List_Next*)malloc(sizeof(struct Link_List_Next));
         ...
         textcolor(YELLOW+BLINK);
   		gotoxy(32,10); cprintf("%d Is Inserted",Temp1->Data);
